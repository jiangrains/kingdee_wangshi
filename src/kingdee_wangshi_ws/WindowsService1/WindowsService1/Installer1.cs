...
namespace WindowsService1
{
    ...
    public partial class Installer1 : System.Configuration.Install.Installer
    {
        public Installer1()
        {
            ...
            si.ServiceName = "tokenTimer";//系统操作服务的标识，要和ServiceBase中设置的ServiceName属性值相同
            si.DisplayName = "token刷新服务";//展示给用户的服务名，即在控制面板中看到的服务名
            si.Description = "用于定时刷新wechat的access token和jsapi ticket";
